...
var ENV_DEP_SERVER = DEVELOPMENT ? ('http://' + DEV_SERVER + ':13000') : 'https://quickened.interoperability.tracking.exposed';
var ENV_DEP_WEB = DEVELOPMENT ? ('http://' + DEV_SERVER + ':1313') : 'https://quickened.interoperability.tracking.exposed';
...
const DEV_PLUGINS = [
    new WebpackNotifierPlugin({
        ...
        urgency: 'critical',
        title: 'evicoas',
        contentImage: path.join(__dirname, 'icons', 'evicoas128.png'),
        timeout: 2,
        alwaysNotify: true
    })
];
